...
impl BuiltinKind {
    ...
    pub fn desribe(&self) -> String {
        match self {
            ...
            BuiltinKind::DynlibOpen => "mod_open".to_string(),
            BuiltinKind::DynlibClose => "mod_close".to_string(),
            BuiltinKind::DynlibRead => "mod_read".to_string(),
            BuiltinKind::DynlibWrite => "mod_write".to_string(),
